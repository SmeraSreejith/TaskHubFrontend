                ...
                <div className="row w-100 mx-auto" style={{ maxWidth: '1100px' }}>
                    ...
                    >
                        <img
                            src={
                                authStatus
                                    ? 'https://img.freepik.com/premium-photo/sign-up-concept-illustration_839035-451688.jpg'
                                    : 'https://cdnl.iconscout.com/lottie/premium/thumb/login-screen-4308924-3582001.gif'
                            }
                            alt=""
                            className="img-fluid"
                    ...
                    <div className="col-12 col-lg-6 p-4">
                        ...
                        <div className="d-flex flex-column flex-lg-row justify-content-between align-items-center">
                            <button
                                className={`btn ${authStatus ? 'btn-warning' : 'btn-danger'} w-100 mb-3 mb-lg-0`}
